...
function row(site) {
  ...
  <th class="site-cell" scope="row"><div class="site-heading"><span class="avatar">${escapeHtml(Array.from(site.name)[0] || "A")}</span><div><a href="${escapeHtml(site.url)}" target="_blank" rel="nofollow noopener" referrerpolicy="origin">${escapeHtml(site.name)} <span aria-hidden="true">↗</span></a><small>查看来源详情</small></div></div><p class="site-description">${escapeHtml(description)}</p><p class="site-date"><span>创建时间</span> ${escapeHtml(dateText(site.establishedDate))}</p></th>
