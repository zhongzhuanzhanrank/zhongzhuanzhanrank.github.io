...
<section class="hero shell"><div>${hero}</div><aside class="snapshot"><strong>${allSites.length}</strong><span>家 AI API 中转站</span><dl><div><dt>当前页</dt><dd>${page} / ${totalPages}</dd></div><div><dt>本页排名</dt><dd>${first}–${last}</dd></div><div><dt>更新时间</dt><dd>${updatedDate}</dd></div></dl></aside></section>
